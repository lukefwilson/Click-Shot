...
{
    CameraRemoteViewController* mainController = (CameraRemoteViewController *)self.window.rootViewController;
    [mainController userClosedApp];
...
//    NSLog(@"will enter foreground");
    CameraRemoteViewController* mainController = (CameraRemoteViewController *)self.window.rootViewController;
    [mainController userReopenedApp];
