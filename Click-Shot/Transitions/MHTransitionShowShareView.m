...
- (void)animateTransition:(id<UIViewControllerContextTransitioning>)transitionContext {
    ...
    if(self.present){
        ...
        if (self.mergedVideoURLPath) {
            [toViewController addItemWithPathStringToGalleryItems:self.mergedVideoURLPath];
        }
        ...
        if (toViewController.pageIndex == NSNotFound || self.mergedVideoURLPath) toViewController.pageIndex = 0;
